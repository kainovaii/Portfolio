<p align="center">
    <br />
    <img src="https://raw.githubusercontent.com/kainovaii/Portfolio/refs/heads/main/src/main/resources/assets/img/favicon.png" width="15%">
    <br />
</p>
...
Bienvenue sur le dépôt de mon **portfolio personnel**, développé en **Java** avec un backend léger et des templates pour l’interface utilisateur.
...
- Interface web simple et **responsive** avec Pebble Templates.
- Backend **léger et rapide** grâce à Spark.
- **Base de données SQLite** avec ActiveJDBC.
- Gestion des **variables d’environnement** via Java Dotenv.
